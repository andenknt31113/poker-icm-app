...
## UI 構成（playground）
モバイル向けの3タブ構成 (v1.1 で 5タブ→3タブに再編):
- ⚙️ セットアップ — プレイヤー・スタック・ペイ構造・ブラインド/アンティ入力、プリセット
- 📊 分析 — ICM/BF/必要勝率 + ハンドレンジ比較 + Nash 均衡の縦フロー (セクションジャンプ付き)
- 🎲 練習 — ランダムシナリオで call/fold 即判定、円卓ビュー、導入コース、復習リスト
